...
from material_law_editor.quadraticFunctionView import QuadraticFunctionView
from material_law_editor.quadraticFunctionInformation import QuadraticFunctionInformation
