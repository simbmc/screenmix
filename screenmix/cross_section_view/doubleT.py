...
from cross_section_view.layer_doubleT import Layer_doubleT

class DoubleT_View(AView,GridLayout):
    # Constructor
    def __init__(self, **kwargs):
        super(DoubleT_View, self).__init__(**kwargs)
        AView.__init__(self)
        self.cols=1
        self.layers = []
    '''
    ...
    def addLayer(self, value, material):
        ...
        if h<=self.th:
            ...
            r2 = FilledRect(xrange=[lx-self.deltaX/2., self.tw+lx-self.deltaX/2.],
                                        yrange=[y2 - l.h2 / 2.-self.deltaY, y2 + l.h2 / 2.-self.deltaY],
                                        color=l.colors)
    ...
    def updateHeight(self):
        ...
        for l in self.layers:
            ...
            elif l.r1.yrange[1]<self.bh+self.mh:
                x=delta-self.mw/2.
            ...
            if l.r2.yrange[1]<self.bh:
                x=delta-self.bw/2.
                l.r2.xrange=[x,x+self.bw]
            elif l.r2.yrange[1]<self.bh+self.mh:
                x=delta-self.mw/2.
            ...
            if l.r3.yrange[1]<self.bh:
                x=delta-self.bw/2.
                l.r3.xrange=[x,x+self.bw]
            elif l.r3.yrange[1]<self.bh+self.mh:
                x=delta-self.mw/2.
                l.r3.xrange=[x,x+self.mw]
            else:
                x=delta-self.tw/2.
    ...
    def on_touch_move(self, touch):
        y0 = self.graph._plot_area.pos[1]  # position of the lowerleft
        gh = self.graph._plot_area.size[1]  # graph size
        ...
        for l in self.layers:
            ...
            if l.r1.color==Design.focusColor:
                ...
                #case 3
                    ...
                    l.setYRange2([self.hmax-self.th-self.mh,self.hmax-self.th])
                    x3=delta-self.bw/2.
                ...
                #case 5
                    ...
                    l.setYRange1([self.bh+self.mh,self.bh+self.mh+height1])
                ...
                #case 6
                    ...
                    l.setYRange3([0,0])
                    if y<self.bh:
                        l.setXRange1([delta-self.bw/2.,delta+self.bw/2.])
                        l.setXRange2([delta-self.bw/2.,delta+self.bw/2.])
                        l.w1=self.bw
                        l.w2=self.bw
                        ...
                        l.setXRange1([delta-self.tw/2.,delta+self.tw/2.])
                        l.setXRange2([delta-self.tw/2.,delta+self.tw/2.])
                        l.w1=self.tw
                        l.w2=self.tw
                    l.w3=0
