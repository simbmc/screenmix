...
class MainWindow(GridLayout):
    ...
    def create_popup(self):
        ...
        self.popup=Popup(title='Menu',content=self.root,size_hint=(None,None),size=(250,self.height*2),pos_hint=({'x':0,'top':1}),pos=(0,0))
    ...
    def create_menu_bar(self):
        bar_height=25
        bar=GridLayout(cols=3,row_force_default=True, row_default_height=bar_height, size_hint_y=None, height=25)
        menu_button=Button(text='menu',size_hint_y=None, height=bar_height,size_hint_x=None, width=100)
